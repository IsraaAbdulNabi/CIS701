...
print (docDF['SENTIMENT'].value_counts())
X=docDF['TEXT']
y=docDF['SENTIMENT']
y=y.astype('int32')
...
print(padded_seqs.shape,y.shape)
...
print (model.fit(X_train,y_train,batch_size=1024,epochs=1,verbose=1,callbacks=callbackslist))
